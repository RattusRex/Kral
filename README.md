...
- `GET /api/projects/current/about` returns the selected project's title and formatted introduction. Technicians and higher roles may update it with `PUT /api/projects/current/about`; choosing a project opens this page first.
