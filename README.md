...
- `POST /api/characters/{id}/calendar/work` reserves a work period, calculates earnings from the campaign tool-proficiency table, credits the character wallet, and records the operation in the finance log. Completed work entries are immutable because their earnings have already been paid.
